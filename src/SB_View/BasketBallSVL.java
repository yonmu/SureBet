...
import SB_Controller.basketballGame;
import SB_Model.UpdateSQL;

//Servlet:
@WebServlet (name = "/BasketBallSVL", urlPatterns = "/BasketBallSVL")
public class BasketBallSVL extends HttpServlet {
	...
	{	
		...
		for(int i=0;i<5;i++)
		{
			...
			Away_win[i] = Double.parseDouble(request.getParameter("cell_r"+i+"c2"));
		}
		...
		String out_str=basketballGame.checkSureBet(Best_HW, Best_AW, bestHW_agency, bestAW_agency);
		if (out_str.equals("No sure bet for this rates"))
		{
			//than no need to update anything
		}
		else
		{
		...
		UpdateSQL.update_BBG(cur_username);	
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"<center>\r\n" + 
				"<div class=\"container\">\r\n" + 
				"  <img src=\"BSpage.jpg\" usemap=\"#image-map\" width=\"850\" height=\"579\" alt=\"Stats\" >\r\n" + 
				"    <map name=\"image-map\">\r\n" + 
